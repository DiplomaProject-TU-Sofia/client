...
import StatisticsDisplay from "@/app/utils/common/StatisticsDisplay";
...
export default function page() {
  ...
  return (
    <>
      <AdminLayout />
      <div className="flex absolute top-[5rem] left-[8rem] right-0 rounded-lg bg-white z-40 h-[91.2vh]">
        <div className="grid relative top-0 right-0 left-0 grid-cols-4 h-[77vh] gap-5 place-items-start justify-start m-10 rounded-xl bg-white z-50 ">
          ...
          { 
            ...
            <button
              ...
              className="mt-20 bg-cyan-600 cursor-pointer hover:bg-cyan-700 transition-all duration-300 text-white text-xl font-semibold py-3 px-6 rounded-full shadow-md flex items-center gap-4"
            >
              Add
