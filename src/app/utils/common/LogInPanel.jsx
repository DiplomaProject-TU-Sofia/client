                        ...
                        <div className="p-10 flex flex-col justify-center items-center gap-5 text-[#BEAB96] font-mono">
                            { 
                                registerView ?
                                    <>
                                    <div>
                                <h1 className="text-3xl font-mono p-10">Register</h1>
                                <hr/>
                            </div>
                            <div className="flex flex-col font-mono gap-10">
                                ...
                                <div className="flex flex-row justify-between items-center">
                                    <button className="bg-[#BEAB96] font-mono text-white p-4 rounded-xl w-[15vw]">Register</button>
                                </div>
                                </div>
                                ...
                                <div className="flex flex-row justify-around gap-10">
                                    <label className="text-xl font-mono">Already have an account ?</label>
                                    <label className="text-xl font-mono underline cursor-pointer" onClick={()=>setRegisterView(false)}>Proceed to Login</label>
                                </div>
                                        </div>
                                    </>
                                    :
                                    <>
                                    <div>
                                <h1 className="text-3xl font-mono p-10">Log into your account</h1>
                                <hr/>
                            </div>
                            <div className="flex flex-col font-mono gap-10">
                                ...
                                <div className="flex flex-row justify-between items-center">
                                    ...
                                    <button className="bg-[#BEAB96] font-mono text-white p-4 rounded-xl w-[15vw]">Log In</button>
                                </div>
                                ...
                                <hr />
                                <div className="flex flex-row justify-between">
                                    <label className="text-xl font-mono">Don't have an account ?</label>
                                    <label className="text-xl font-mono underline cursor-pointer" onClick={()=>setRegisterView(true)}>Register now</label>
                                </div>
                                        </div>
                                    </>
